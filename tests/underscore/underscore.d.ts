...
interface IUnderscoreStatic {


	// PV: I don't think you can match this behavior (static typing)
	...
	// **/
	// <T>(value: Array<T>): IUnderscore<T>;
	// <T>(value: T): IUnderscore<T>;
...
declare var _: IUnderscoreStatic;
