...
module TypeScript {
    ...
    export class TypeChecker {
        ...
        public createAccessorSymbol(funcDecl: FuncDecl, fgSym: Symbol, enclosingClass: Type, addToMembers: boolean, isClassProperty: boolean, scope: SymbolScope, container: Symbol) {
        ...
        public canContextuallyTypeFunction(candidateType: Type, funcDecl: FuncDecl, beStringent: boolean): boolean {
