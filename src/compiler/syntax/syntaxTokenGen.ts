...
module TypeScript.Syntax {
	...
	function toRsMemList<T extends ISyntaxToken>(token: T, helper: RsHelper): RsList<RsAST> {
    ...
    function toRsClassElt(token: ISyntaxToken, helper: RsHelper, mut: RsType): RsClassElt {
